...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('sales.receipt', ['transaction' => $transaction->id]) }}" class="btn btn-primary"
                target="_blank">
                    ...
                    <div class="card-body flex-grow-1">
                        <table class="table table-borderless mb-0">
                            ...
                            <tr>
                                ...
                                <td>{{ $transaction->created_at ? $transaction->created_at->format('M d, Y h:i A') : 'N/A' }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge bg-{{ $transaction->payment_method == 'cash' ? 'success' : ($transaction->payment_method == 'gcash' ? 'info' : 'warning') }}">
